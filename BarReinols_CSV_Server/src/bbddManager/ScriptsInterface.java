...
public interface ScriptsInterface {
	...
	String[] insertIntoProductos = {
			...
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Cerveza', 1.70, 'Cerveza proviniente de Granada con baja fermentación.','..\\\\res\\\\img\\\\imgAlhambra.jpg', 'imgalhambra', ?, 1)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Nestea al limón', 1.75, 'Bebida refrescante con sabor a té al limón.','..\\\\res\\\\img\\\\imgNestea.jpg', 'imgnestea', ?, 1)",
			
			// Categoria Cafeteria
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Café solo', 1.25, 'Taza pequeña con una carga de café sin leche.','..\\\\res\\\\img\\\\imgCafeSolo.jpg', 'imgcafesolo', ?, 2)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Café cortado', 1.35, 'Taza mediana con una carga de café con un chorro de leche.','..\\\\res\\\\img\\\\imgCafeCortado.jpg', 'imgcafecortado', ?, 2)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Café con leche', 1.50, 'Taza grande con doble carga de café y un chorro de leche.','..\\\\res\\\\img\\\\imgCafeConLeche.jpg', 'imgcafeconleche', ?, 2)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Café americano', 1.40, 'Taza mediana con doble carga de café sin leche.','..\\\\res\\\\img\\\\imgCafeAmericano.jpg', 'imgcafeamericano', ?, 2)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Carajillo de Baileys', 1.60, 'Taza mediana con una carga de café con un chorro de licor Baileys.','..\\\\res\\\\img\\\\imgCarajillo.jpg', 'imgcarajillo', ?, 2)",
			
			// Categoria Ensaladas
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Ensalada Cesar', 5.95, 'Ensalada con pollo, picatostes, salsa César y frutos secos','..\\\\res\\\\img\\\\imgEnsaladaCesar.jpg', 'imgensaladacesar', ?, 3)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Ensalada de la huerta', 4.95, 'Ensalada con mezclum, brotes, tomate, pepino y aliñada con aceite de oliva y vinagre','..\\\\res\\\\img\\\\imgEnsaladaHuerta.jpg', 'imgensaladahuerta', ?, 3)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Ensalada tropical', 5.49, 'Ensalada con mezclum, piña y queso.','..\\\\res\\\\img\\\\imgEnsaladaTropical.jpg', 'imgensaladatropical', ?, 3)",
			...
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Macarrones a la boloñesa', 5.95, 'Macarrones con tomate y carne picada mixta de ternera y cerdo y queso parmesano','..\\\\res\\\\img\\\\imgMacarronesBolonesa.jpg', 'imgmacarronesbolonesa', ?, 4)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Pasta con frutos de mar', 7.49, 'Pasta a elección con gambas, mejillones y escamarlÃ¡n.','..\\\\res\\\\img\\\\imgPastaConMarisco.jpg', 'imgpastaconmarisco', ?, 4)",
			
			// Categoria Carnes
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Solomillo de cerdo ibérico a la pimienta', 12.95, 'Solomillo de cerdo ibérico con salsa de pimienta verde','..\\\\res\\\\img\\\\imgSolomilloCerdo.jpg', 'imgsolomillocerdo', ?, 5)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Abanico ibérico', 11.95, 'Abanico de cerdo ibérico con patatas de guarnaición.','..\\\\res\\\\img\\\\imgAbanicoCerdo.jpg', 'imgabanicocerdo', ?, 5)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Entrecotte de ternera wagyu a la brasa', 23.49, 'Entrecotte de ternera WAGYU a la brasa con guarnición de patatas al caliu.','..\\\\res\\\\img\\\\imgEntrecotteBrasa.jpg', 'imgentrecottebrasa', ?, 5)",
			...
			// Categoria Pescados
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Lubina a la plancha con limón y ajetes', 16.49, 'Lubina hecha a la plancha con jugo de limón y ajetes braseados','..\\\\res\\\\img\\\\imgLubinaAjetes.jpg', 'imglubinaajetes', ?, 6)",
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Emperador con salsa verde', 21.99, 'Emperador hecho a la plancha con deliciosa salsa verde hecha a partir de vino blanco, ajo, limón, perejil y cebolla.','..\\\\res\\\\img\\\\imgEmperador.jpg', 'imgemperador', ?, 6)",
			...
			// Categoria Postres
			"INSERT INTO productos (nombre, precio_producto, descripcion, imagen, image_movil, image_blob, id_categoria) VALUES ('Coulant de chocolate', 7.49, 'Pequeño pastel de chocolate relleno de foundant de chocolate suizo negro.','..\\\\res\\\\img\\\\imgCoulant.jpg', 'imgcoulant', ?, 7)",
